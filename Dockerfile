...
FROM registry.gitlab.com/clarin-eric/docker-alpine-supervisor-java-base:openjdk17-1.2.1 AS backend_builder
...
FROM registry.gitlab.com/clarin-eric/docker-alpine-supervisor-java-base:openjdk17-1.2.1
