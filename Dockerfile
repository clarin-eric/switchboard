...
FROM registry.gitlab.com/clarin-eric/docker-alpine-clrs-build_env:2.0.0 AS webui_builder
...
FROM registry.gitlab.com/clarin-eric/docker-alpine-supervisor-java-base:openjdk11-1.2.3 AS backend_builder
