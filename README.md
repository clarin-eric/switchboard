[![CI](https://github.com/clarin-eric/switchboard/workflows/CI/badge.svg?branch=2.2.x)](https://github.com/clarin-eric/switchboard/actions?query=workflow%3ACI+branch%3A2.2.x)
