...
import {setResourceProfile, setResourceContent, removeResource, uploadLink, selectResourceMatch, toggleArchiveEntryToInputs, extractCompressedResource, toggleTextExtraction} from '../actions/actions';
