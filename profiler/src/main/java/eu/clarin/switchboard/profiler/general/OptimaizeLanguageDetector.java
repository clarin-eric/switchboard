...
public class OptimaizeLanguageDetector implements LanguageDetector {
    private static final ch.qos.logback.classic.Logger LOGGER = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(OptimaizeLanguageDetector.class);

    public static final int SHORT_TEXT_THRESHOLD = 15;
    static com.optimaize.langdetect.LanguageDetector detector;
